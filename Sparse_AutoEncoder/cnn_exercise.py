...
train_images = stl_train['trainImages']  #(64L, 64L, 3L, 2000L)
train_labels = stl_train['trainLabels']  #(2000L, 1L)
...
stl_test = scipy.io.loadmat('E:\important_dataset\stlTestSubset.mat')
